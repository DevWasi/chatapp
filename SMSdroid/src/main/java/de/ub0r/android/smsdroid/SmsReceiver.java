...
public class SmsReceiver extends BroadcastReceiver {
    ...
    private static Object NotificationBroadcastReceiver;
                ...
                if (enableNotifications) {
                    ...
                    if (conv != null) {
                        ...
                        if (l == 1) {
                            ...
                            // add actions
                            PendingIntent markReadPendingIntent = PendingIntent.getBroadcast(context, 0, new Intent(String.valueOf(NotificationBroadcastReceiver.getClass())), PendingIntent.FLAG_CANCEL_CURRENT);
